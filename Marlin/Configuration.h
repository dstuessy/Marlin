...
#define CONFIG_EXAMPLES_DIR                                                    \
  "config/examples/Creality/Ender-3 Pro/BigTreeTech SKR Mini E3 3.0"
...
#define STRING_CONFIG_H_AUTHOR                                                 \
  "(thisiskeithb, Ender-3 Pro)" // Who made the changes.
...
#define MANUAL_X_HOME_POS 2.55
#define MANUAL_Y_HOME_POS -10.35
...
#define NEOPIXEL_TYPE                                                          \
  NEO_GRB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.
          // See
...
#define NEOPIXEL_PIXELS                                                        \
  10 // Number of LEDs in the strip. (Longest strip when NEOPIXEL2_SEPARATE is
     // disabled.)
